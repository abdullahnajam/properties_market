class Property{
  String id,name,location,country,city,area,typeOfProperty,propertyCategory,
  ...
  Property(this.id, this.image, this.name, this.location, this.country, this.city, this.area, this.typeOfProperty, this.propertyCategory,
